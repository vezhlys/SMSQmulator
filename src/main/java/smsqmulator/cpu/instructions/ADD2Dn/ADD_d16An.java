 ...
 */
public class ADD_d16An implements InstructionSet
{
         ...
         for (int sz = 0; sz < 8; sz++)                       
        {
            ...
            if(sz == 0)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // byte sized add
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        boolean Sm, Rm,Dm;
                        int reg=(opcode>>9)&7;
                        int s=cpu.readMemoryByteSigned(cpu.addr_regs[opcode &7] + cpu.readMemoryWordPCSignedInc());//source value
                        Sm=s<0;
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // word sized add
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        boolean Sm, Rm,Dm;
                        int reg=(opcode>>9)&7;
                        int s=cpu.readMemoryWordSigned(cpu.addr_regs[opcode &7] + cpu.readMemoryWordPCSignedInc());//source value
                        Sm=s<0;
           ...
           else if(sz == 2)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // long sized add
                {
                    ...
                    {
                        int reg=(opcode>>9)&7;
                        int s=cpu.readMemoryLong(cpu.addr_regs[opcode &7] + cpu.readMemoryWordPCSignedInc());//source value
                        boolean Sm= s<0;
            ...
            else if (sz == 3)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // word sized add
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        cpu.addr_regs[(opcode>>9)&7]+=cpu.readMemoryWordSigned(cpu.addr_regs[opcode &7] + cpu.readMemoryWordPCSignedInc());//source value
                    }
                   @Override
                    public DisassembledInstruction disassemble(int address, int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
            ...
            else 
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // long sized add
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        cpu.addr_regs[(opcode>>9)&7]+=cpu.readMemoryLong(cpu.addr_regs[opcode &7] + cpu.readMemoryWordPCSignedInc());//source value
                    }
                   @Override
                    public DisassembledInstruction disassemble(int address, int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
