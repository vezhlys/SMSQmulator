 ...
 *          sss= size (000=byte, 001 = word, 010 = long, 011 = word adress reg,111 = long address reg )
 *          mmm = mode =001, 
 *          rrr = source reg
 ...
 */
public class CMP_An implements InstructionSet
{
    @Override
        ...
        for(int sz =1 ; sz < 5; sz++)
        {
            if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    { 
                        int s=cpu.addr_regs[opcode & 0x07]&0xffff;//source value     
            ...
            else if (sz==2)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        int s=cpu.addr_regs[opcode & 0x07];//source value
