...
public class DIVSW implements InstructionSet
{
    @Override
            ...
            public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
            {
                ...
                switch ((opcode>>>3)&0x7)
                {
                    case 0:                                     // DN
                        ...
                        if((secondvalue & 0x8000) !=00)
                            secondvalue|= 0xffff0000;                    
                        break;
                    case 2:                                     // (an)
                ...
                cpu.reg_sr&=0xfff0;                        // X bit not affected by divs, c always cleared
                if (secondvalue==0)
                {
