...
/**
 * The LSL instruction where data to be shifted is in memory.
 * 1110000111mmmrrr = 0xe3C0   
 * 
 * mmm = mode 010
...
public class LSLmem implements InstructionSet
{
    @Override
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        i = new smsqmulator.cpu.Instruction()   
        {
            ...
            public DisassembledInstruction disassemble(int address, int opcode,smsqmulator.cpu.MC68000Cpu cpu)
            {
                ...
                return new DisassembledInstruction(address, opcode, "lsl" + Size.Word.ext(), src);
            }   
