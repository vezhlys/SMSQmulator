 ...
 * 
 * Based on Tony Headford's  m68k.cpu.instruction (C) Tony Headford, see his icence below
 */
...
public class LSLreg implements InstructionSet
{
    @Override
