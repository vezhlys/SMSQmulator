...
/**
 * The LSR instruction where data to be shifted is in a data reg and the shift count is immediate.
 * 1110ccc0ss001rrr = 0xe008   
 * 
 * mmm = mode 010
 ...
 * @version
 *  1.01 LSR.L corrected, used >> instead of >>>
...
public class LSRimm implements InstructionSet
{
    @Override
            ...
            else
            {
                ...
                i = new smsqmulator.cpu.Instruction()   
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        cpu.reg_sr&=0xffe0;                // all status flags set to 0
                        if (val<0)                // ms bit set (could be if 0 shift count)
