...
/**
 * MOVE where source is absolute .L and destination is d16(An).
  00ssxxxyyymmmrrr
 * s = size bit
 * x=dest register 
...
public class MOVEAnL5 implements InstructionSet
{
    @Override
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        cpu.pc_reg+=2;int displacement = cpu.readMemoryWordPCSignedInc();
