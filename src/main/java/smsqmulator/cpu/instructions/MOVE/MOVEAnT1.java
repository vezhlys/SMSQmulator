...
/**
 * MOVE where source is immediate DATA and destination is Dn.
 * 
  00ssxxxyyymmmrrr
 * s = size bit
 * x=dest register 
...
public class MOVEAnT1 implements InstructionSet
{
    @Override
            ...
            if(sz == 0)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int reg=(opcode>>9)&7;
                        cpu.data_regs[reg]=(cpu.data_regs[reg]&0xffffff00)|s;// get content, sign exten
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int reg=(opcode>>9)&7;
                        cpu.data_regs[reg]=(cpu.data_regs[reg]&0xffff0000)|s;// get content, sign exten
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
            ...
            else
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        cpu.data_regs[(opcode>>9)&7]=s;// get content, sign exten
                        cpu.pc_reg+=2;
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
