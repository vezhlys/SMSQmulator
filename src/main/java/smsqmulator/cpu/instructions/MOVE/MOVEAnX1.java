...
/**
 * MOVE where source is d8(Pc,Xn) and destination is Dn.
 * 
  00ssxxxyyymmmrrr
 * s = size bit
 * x=dest register 
...
public class MOVEAnX1 implements InstructionSet
{
    @Override
            ...
            if(sz == 0)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int dest=(opcode>>9)&7;
                        cpu.data_regs[dest]=(cpu.data_regs[dest]&0xffffff00)|s;
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int dest=(opcode>>9)&7;
                        cpu.data_regs[dest]=(cpu.data_regs[dest]&0xffff0000)|s;
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
