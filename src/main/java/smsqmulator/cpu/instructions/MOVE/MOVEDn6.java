...
/**
 * MOVE where source is DN and destination is d8(An,Xn) - (An) with displacement.
 * 
 * 00ssxxxyyymmmrrr
 * s = size bit
 * x=dest register (An)
 ...
 * so base = 0x1180 for byte,0x2180 for long,0x3180 for word, 
 * 
...
public class MOVEDn6 implements InstructionSet
{
    @Override
