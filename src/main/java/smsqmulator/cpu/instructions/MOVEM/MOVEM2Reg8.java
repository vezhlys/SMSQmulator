...
/**
 * This is the MOVEM from d8(pc,Xn) memory to reg instruction.
 *      d
 * 010011001smmmrrr
 * where :
...
public class MOVEM2Reg8 implements InstructionSet
{
            ...
            if(sz == 0)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int address=  cpu.pc_reg*2+getDisplacement(cpu);
                        int bit = 1;
