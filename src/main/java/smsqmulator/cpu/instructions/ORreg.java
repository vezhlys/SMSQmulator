 ...
 */
public class ORreg implements InstructionSet
{
    @Override
                            ...
                            case 7:
                                switch (opcode&7)
                                {
                                    ...
                                    case 4:                             // immediate data
                                        val=cpu.readMemoryWordPCInc()&0xff;//source value
                                        readByte=false;
                                        break;
                                }
                                break;
   ...
   /**
     ...
     * 
     * @param cpu the smsqmulator.cpu.MC68000Cpu used the cpu use
     * d.
