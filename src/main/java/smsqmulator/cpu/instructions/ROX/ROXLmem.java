...
/**
 * The ROXL instruction where data to be shifted is in memory.
 * 1110010111mmmrrr = 0xe5C0   
 * 
 * mmm = mode 
...
public class ROXLmem implements InstructionSet
{
    @Override
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        i = new smsqmulator.cpu.Instruction()   
        {
            ...
            { 
                ...
                cpu.reg_sr&=0xffe0;                        // all status flags set to 0 (rotate is always 1)
                if (val==0)
