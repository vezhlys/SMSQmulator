 ...
 * 
 * Based on Tony Headford's SUB class copyright (C) Tony Headford, see his licence below
 */
public class SUB_AnPlus implements InstructionSet
{
    @Override
