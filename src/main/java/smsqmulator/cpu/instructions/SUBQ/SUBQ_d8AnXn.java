 ...
 */
public class SUBQ_d8AnXn implements InstructionSet
{
    @Override
            ...
            if(sz == 0)                                     // sub a byte
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int r = d-s;
                        cpu.writeMemoryByte(cpu.addr_regs[reg]+displacement,r);
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    { 
                        ...
                        int r = d-s;
                        cpu.writeMemoryWord(cpu.addr_regs[reg]+displacement,r);
                        cpu.reg_sr&=0xffe0;            // all flags 0
                        boolean Sm = false;                 // source is never neg
            ...
            else
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int r = d-s;
                        cpu.writeMemoryLong(cpu.addr_regs[reg]+displacement,r);
