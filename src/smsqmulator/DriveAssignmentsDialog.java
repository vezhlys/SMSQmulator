 ...
 * @version 1.00 set better JTextField sizes : min 200 or max string length.
 * @version 0.02 Really take into account text typed in directly in the TextFields.
 * @version 0.01 take into account text typed in directly in the TextFields.
 * @version 0.00
 */
public class DriveAssignmentsDialog extends javax.swing.JDialog 
{
    ...
    */
    public DriveAssignmentsDialog(java.awt.Frame parent, boolean modal,String []presets,String deviceName,boolean mustBeDir) 
    {
        super(parent, modal);
        this.parent=parent;
        ...
        System.arraycopy(presets, 0,this.options,0,8);
        this.tf1=new javax.swing.JTextField[8];             // there will be one textfield for each dir
        this.getContentPane().setLayout(new javax.swing.SpringLayout());
        ...
        for (int i=0;i<8;i++)                               // build the textfields
        {
            ...
            this.getContentPane().add(new javax.swing.JLabel(deviceName+(1+i)));
            ...
            this.getContentPane().add(this.tf1[i]);
        ...
        this.getContentPane().add(new javax.swing.JLabel(""));// bogus component to fill the last row
        
        SpringUtilities.makeCompactGrid(getContentPane(),   // use the spring utilities to put everything in a grid
                                 8+1, 3,                    //rows, cols
