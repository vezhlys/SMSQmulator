 ...
 * 
 */
public class ANDmem implements InstructionSet
{
    @Override
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        switch ((opcode >>3)&7)                 // select on dest ea mode
                        {
                            ...
                            case 4:                                     // -(an)
                                ...
                                break;                                  
                            case 5:                                     // d16(an)
                                address=cpu.addr_regs[src] + cpu.readMemoryWordPCSignedInc();
                                break;
                            case 6:                                     // d8(an,xn)
                                address=getDisplacement(cpu)+cpu.addr_regs[src];
                                break;
                            case 7:
                                switch (opcode &7)
                                {
