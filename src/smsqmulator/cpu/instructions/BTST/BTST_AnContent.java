 ...
 * 
 * 00000ddd100mmmrrr = 0x0110   for dynamic mode
 * 00001000000mmmrrr = 0x0810   for static mode
 * 
 * mmm = mode 010
 * rrr = register
 * 
...
public class BTST_AnContent implements InstructionSet
{
    @Override
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        { 
            ...
            public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
            {
                ...
                //n z v c
                //8 4 2 1
                int dest=cpu.readMemoryByte(cpu.addr_regs[opcode&7]);
