 ...
 * 
 * 00000ddd100111000 = 0x0139   for dynamic mode
 * 00001000000111000 = 0x0839   for static mode
 * 
 * mmm = mode 010
 * rrr = register
 * 
...
public class BTST_L implements InstructionSet
{
    ...
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        {        
            ...
            public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
            {
                ...
                //n z v c
                //8 4 2 1
                int dest=cpu.readMemoryByte(cpu.readMemoryLongPC());
                cpu.pc_reg+=2;
        ...
        cpu2.addInstruction(0x139, i);
        cpu2.addInstruction(0x839, i);
    }
