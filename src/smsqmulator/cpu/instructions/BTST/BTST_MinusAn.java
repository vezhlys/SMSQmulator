 ...
 * 
 * 00000ddd100mmmrrr = 0x0120   for dynamic mode
 * 00001000000mmmrrr = 0x0820   for static mode
 * 
 * mmm = mode 100
 * rrr = register
 * 
...
public class BTST_MinusAn implements InstructionSet
{
    ...
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        { 
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
            {
                ...
                int dest=cpu.readMemoryByte(cpu.addr_regs[reg]);
