...
/**
 * The LSL instruction where data to be shifted is in a data reg and the shift count is immediate.
 * 1110ccc1ss001rrr = 0xe108  
 * 
 * mmm = mode 010
...
public class LSLimm implements InstructionSet
{
    @Override
