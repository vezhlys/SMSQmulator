...
/**
 * The LSR instruction where data to be shifted is in a data reg and the shift count is in another data reg.
 * 1110ccc0ss101rrr = 0xe028   
 * 
 * mmm = mode 010
...
public class LSRreg implements InstructionSet
{
    @Override
