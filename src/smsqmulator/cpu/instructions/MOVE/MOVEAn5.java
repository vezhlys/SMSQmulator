...
/**
 * MOVE where source is AN and destination is d16(AN) - (An) with displacement.
 * 
 * 00ssxxxyyymmmrrr
 * s = size bit
 * x=dest register (An)
 ...
 * so base = 0x1148 for byte,0x2148 for long,0x3148 for word, 
 * @author wolf
 */
...
public class MOVEAn5 implements InstructionSet
{
    @Override
