...
/**
 * MOVE where source is DN and destination is .W absolute word.
 * 
 * 00ssxxxyyymmmrrr
 * s = size bit
 * x=dest register 000
 ...
 * so base = 0x11c0 for byte,0x21c0 for long,0x31c0 for word, 
...
public class MOVEDn7 implements InstructionSet
{
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        for(int sz = 0; sz < 3; sz++)
        {
            if(sz == 0)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        cpu.writeMemoryByte(cpu.readMemoryWordPCSignedInc(), s);
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        cpu.writeMemoryWord(cpu.readMemoryWordPCSignedInc(), s);
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
            ...
            else
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        cpu.writeMemoryLong(cpu.readMemoryWordPCSignedInc(), s);
                        cpu.reg_sr&=0xfff0;
                        if (s==0)
                        {
                            cpu.reg_sr+=4;
            ...
            {
                cpu2.addInstruction(base + dea_reg, i);
            }
        }
    }
