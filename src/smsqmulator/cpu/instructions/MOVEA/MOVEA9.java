...
public class MOVEA9 implements InstructionSet
{
    @Override
        ...
        for(int sz = 1; sz < 3; sz++)
        {
            if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    {
                        cpu.addr_regs[(opcode>>9)&7] = cpu.readMemoryWordSigned(cpu.readMemoryLongPCinc());
                    }
                    @Override
            ...
            else
            {
                ...
                i = new smsqmulator.cpu.Instruction()
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        cpu.addr_regs[(opcode>>9)&7]=cpu.readMemoryLong( cpu.readMemoryLongPCinc());
                    }
                    @Override
                    public DisassembledInstruction disassemble(int address, int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
