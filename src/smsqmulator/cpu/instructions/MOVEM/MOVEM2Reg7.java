...
/**
 * This is the MOVEM from d16(pc) memory to reg instruction.
 *      d
 * 010011001smmmrrr
 * where :
...
public class MOVEM2Reg7 implements InstructionSet
{
    @Override
            ...
            if(sz == 0)
            {
                ...
                {  
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        ...
                        int address=cpu.pc_reg*2+ cpu.readMemoryWordPCSignedInc();         // get mem sign extended
                        int bit = 1;
