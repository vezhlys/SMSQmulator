...
/**
 * The ROL instruction where data to be rotated is in a data reg and the rotate count is immediate.
 * 1110ccc1ss011rrr = 0xe118  
 * 
 * mmm = mode 010
...
public class ROLimm implements InstructionSet
{
    @Override
