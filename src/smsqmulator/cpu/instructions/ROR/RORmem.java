...
/**
 * The ROR instruction where data to be rotated is in memory.
 * 1110011011mmmrrr = 0xe6C0  
 * 
 * mmm = mode 010
...
public class RORmem implements InstructionSet
{
    @Override
    public final void register(final smsqmulator.cpu.MC68000Cpu cpu2)
    {
        ...
        i = new smsqmulator.cpu.Instruction()   
        {
            ...
            { 
                ...
                cpu.reg_sr&=0xfff0;                        // all status flags set to 0 (value can't be negative)
                if (val==0)
                    cpu.reg_sr+=4;                         // set Z flag 
                if (lastOut!=0)
                    cpu.reg_sr|=9;                        // set C + N flags   
            }
