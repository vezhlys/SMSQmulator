 ...
 */
public class SUB_I implements InstructionSet
{
    @Override
        ...
        for(int sz = 0; sz < 8; sz++)                       
        {
            ...
            else if(sz == 3)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // word sized SUBa
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        cpu.addr_regs[(opcode>>9)&7]-=cpu.readMemoryWordPCSignedInc();//source value;
                    }
                   @Override
                    public DisassembledInstruction disassemble(int address, int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
            ...
            else 
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // long sized SUBa
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        cpu.addr_regs[(opcode>>9)&7]-=cpu.readMemoryLongPC();//source value
                        cpu.pc_reg+=2;
                    }
                   @Override
                    public DisassembledInstruction disassemble(int address, int opcode,smsqmulator.cpu.MC68000Cpu cpu)
