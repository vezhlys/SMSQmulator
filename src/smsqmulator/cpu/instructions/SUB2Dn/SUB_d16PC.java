 ...
 */
public class SUB_d16PC implements InstructionSet
{
    @Override
            ...
            if(sz == 0)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // byte sized SUB
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        boolean Sm, Rm,Dm;
                        int reg=(opcode>>9)&7;
                        int s=(cpu.readMemoryByteSigned(cpu.pc_reg*2 + cpu.readMemoryWordPCSignedInc()));
                        Sm=s<0;
            ...
            else if(sz == 1)
            {
                ...
                i = new smsqmulator.cpu.Instruction()    // word sized SUB
                {
                    ...
                    public final void execute(int opcode,smsqmulator.cpu.MC68000Cpu cpu)
                    {
                        boolean Sm, Rm,Dm;
                        int reg=(opcode>>9)&7;
                        int s=cpu.readMemoryWordSigned(cpu.pc_reg*2 + cpu.readMemoryWordPCSignedInc());
                        Sm=s<0;
